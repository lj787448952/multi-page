    ...
    return (
      <form className={classes.root} noValidate autoComplete="off">
        ...
        <div className={classes.root}>
          <Button variant="outlined" onClick={this.handleIns}>新 增</Button>
          <Button variant="outlined" color="primary" onClick={this.handleQuery}>
            查 詢
          </Button>
          <Button variant="outlined" color="secondary" onClick={this.handleMod}>
            修 改
          </Button>
          <Button variant="outlined" color="primary" onClick={this.handleDel}>
            刪除
          </Button>
        </div>
      </form>
